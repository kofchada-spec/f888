...
const EnhancedMap: React.FC<EnhancedMapProps> = ({ 
  ...
  // Auto-generate route for one-way trips
  useEffect(() => {
    if (map.current && planningData && planningData.tripType === 'one-way' && userLocation && mapboxToken && !hasAutoGenerated && !isCalculating) {
